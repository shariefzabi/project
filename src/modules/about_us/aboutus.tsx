  ...
  return (
    <div className="body aboutus-container">
      ...
      <section className="d-flex ">
          ...
          <div className="theory-y text-white">
            ...
            <div className="theory">
              <div className="livestock247">
                <p className="li">
                  Livestock247.com is an online livestock market and listing
                  platform.
                </p>
                <p className="li">We are based in Africa, Nigeria</p>
                <p className="li divider">
                  We work together to create and produce good food that we are
                  proud of for people and organizations
                </p>
              ...
              <div className="d-flex  logo ">
                <div>
                  <img
                    src={require("./assets/img/shopping-1.png")}
                    alt="logo"
                  />
                ...
                <div>
                  <img
                    src={require("./assets/img/payment-method-1.png")}
                    alt="logo"
                  />
                ...
                <div>
                  <img
                    src={require("./assets/img/suitcase-1.png")}
                    alt="logo"
                  />
              ...
              <div className=" d-flex logo2">
                <div>
                  <img
                    src={require("./assets/img/delivery-truck-1.png")}
                    alt="logo2"
                  />
                ...
                <div>
                  <img
                    src={require("./assets/img/customer-service-1.png")}
                    alt="logo2"
                  />
        ...
        <div>
          <img
            className="checkboard-b real_img"
            src={require("./assets/img/Image.png")}
            alt="checkboard"
          />
          <img
            className="checkboard-b responcive_img"
            src={require("./assets/img/responcive_2.png")}
            alt="checkboard"
          />
          <img
            className="checkboard-b blue_container_responcive"
            src={require("./assets/img/blue_rectangle.png")}
          ></img>
        </div>
      </section>
        ...
        <div className="d-flex ">
          <div>
            <img
              ...
              src={require("./assets/img/blue bg.png")}
              alt="blue bg"
            />
            <img
              className="chessboard "
              src={require("./assets/img/chessboard.png")}
              alt="chessboard"
            />
          </div>
          <div>
            ...
            <div className="discript">
              <ul className="bulletsremove">
                ...
                <li>
                  <p className="mb-0">
                    {" "}
                    Ability to sell Livestock by Merchants, Ranchers and feedlot
                    operators etc.
                  </p>
                </li>
                <li>
                  <p className="mb-0">
                    Ability to buy Livestock from anywhere in Nigeria and get it
                    delivered.
                  </p>
                </li>
                <li>
                  <p className="mb-0">
                    {" "}
                    Ability to buy Livestock according to breed, weight, colour,
                    age and sex
                  </p>
                </li>
                <li>
                  <p className="mb-0">
                    ...
                    Secure online payment Fast and stress-free delivery
                  </p>
                </li>
                <li>
                  <button className="btn btn-success brochure">
      ...
      <div className="family">
        ...
        <p className="family-text">
          The CEO with some team members of Technology, Quality Control, Digital
          Marketing Strategy, Logistic, Finance and Customer Support
        </p>
      </div>
          ...
          <div className="container search text-white">
            <form className="searchbar d-flex">
              ...
              <button className="text-white">
                Subscribe{" "}
                <img
                  src={require("./assets/img/frontarrow.png")}
                  className="ps-3"
                />
              </button>
            </form>
            ...
            <div className="row">
              <div className="col">
                <div className="paragraph">
                  <p>
                    The vision of Livestock247.com is to mitigate the spread of
                    zoonotic diseases through the provision of fit-for-slaughter
                    and traceable livestock to our customers.
                  </p>
                </div>
              </div>
              <div className="col">
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <ul>
                      ...
                      <li>
                        4th Floor ,valley view Plazza, 99 Opebi
                        Road,IKeja,Lagesngeria
                      </li>
                    </ul>
                  </div>
                </div>
