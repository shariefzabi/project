        ...
        return (
            <div>
                ...
                <section className="text-center">
                    <div className="d-flex justify-content-between main_box ">
                        <div className="left_box">
                            <div className="first_box md-2"><p className="info">ONLINE PLATFORM TO BRIDGE IN LIVESTOCK.....</p></div>
                            <div className="d-flex justify-content-between two_box">
                            ...
                            <div className="img_hor"><p className="info">ONLINE PLATFORM TO BRIDGE IN LIVESTOCK.....</p></div>
                            <div className="d-flex justify-content-between two_box">
