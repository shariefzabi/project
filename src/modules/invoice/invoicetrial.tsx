                    ...
                    <main className="invoice-body">
                        ...
                        <hr className="hr-line" />
                        {
                            ...
                            invoice.map((data, ind) => {
                                ...
                                return (
                                    <div key={ind}>
                                        <p className="invoice-id">ID - 900085000597636<img className="text-end" onClick={(e) => invoiceToggle(e)} data-bs-toggle="collapse" data-bs-target={index} aria-expanded="false" aria-controls="collapseExample" src={triangle1}></img></p>
