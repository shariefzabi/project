...
function SelectedProductDetails(props: any) {
    ...
    let [delwish, setDelwish] = useState(true);
    ...
    const setMarketHandler = (event: any) => {
        ...
        navigate("/products");
        console.log("spp", market)
        props.setLocationName(location)
        props.setMarketType(event.target.value)
                            ...
                            <div className="imgdetails col-12 d-flex  mt-3">
                                ...
                                <div className=" prodetail col-lg-7 col-md-7 col-sm-7  p-0 ">
                                    ...
                                    {!(wishlistIDS.includes(product._id)) &&
                                        ...
                                        <button className="wishListButton" onClick={addtoWishlist}>{!inWhishlist &&
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart wishListImg" viewBox="0 0 16 16">
                                    ...
                                    {(wishlistIDS.includes(product._id)) &&
                                        <button className="wishListButton" onClick={deleteFromWishlist}>{delwish &&
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart-fill text-danger" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                                            </svg>}{!delwish &&
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart wishListImg" viewBox="0 0 16 16">
