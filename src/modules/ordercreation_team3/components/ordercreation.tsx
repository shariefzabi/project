    ...
    return (
        <>
            <div className='ordercreation-container'>
                                    ...
                                    <div className='row'>
                                        <div className="col-md-3 productype-dropdown" >
                                            <div className="dropdown" >
                                                <select name="Type" value={type} onChange={(event) => Validate(event)} onBlur={(event) => Validate(event)} required className="form-select" >
                                        ...
                                        <div className="col-md-2">
                                            <div className="dropdown" >
                                                <select name="Quantity" value={quantity} onChange={(event) => Validate(event)} onBlur={(event) => Validate(event)} required className="form-select" >
                                        ...
                                        <div className="col-md-1">
                                            ...
                                            <div className="dropdown">
                                                <select name="Sex" value={sex} onChange={(event) => Validate(event)} required onBlur={(event) => Validate(event)} className="form-select" >
                                        ...
                                        <div className="col-md-2">
                                            ...
                                            <div className="dropdown">
                                                <select name="Weight" value={weight} onChange={(event) => Validate(event)} required onBlur={(event) => Validate(event)} className="form-select" >
                                        ...
                                        <div className="col-md-2">
                                            ...
                                            <div className="dropdown">
                                                <select name="Breed" value={breed} onChange={(event) => Validate(event)} required onBlur={(event) => Validate(event)} className="form-select">
                ...
                <button className="buy-button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Buy Now</button>
