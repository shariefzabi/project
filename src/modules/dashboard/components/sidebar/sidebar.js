...
export default function Sidebar() {
    ...
    return (
        <div>
            <nav class="sidebar position-fixed d-none d-sm-block">
                <ul class="nav flex-column fixed-left">
                    <li class="nav-item">
                        <a class="btn nav-link text-secondary active" tabindex="0" role="button" data-mdb-toggle="popover"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="orders.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="invoice.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="payments.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="trackOrder.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="logOut.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <nav>
                <div class="d-sm-none position-fixed">
                    <a class="btn-togglemenu" type="button" onClick={MenuToggler}>
                ...
                <section id="mobile-menu" class="mobile-menu">
                    <div class="container">
                        <a type="button" class="btn-closemenu" onClick={CloseMenu}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <footer class="terms">
                        ...
                        <a class="text-light text-decoration-none" href="#">PRIVACY</a>
