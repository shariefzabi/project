...
export default function Sidebar() {
    return (
        <div>
            <nav className="sidebar position-fixed">
                <ul className="nav flex-column fixed-left">
                    <li className="nav-item">
                        <a className="btn nav-link text-secondary active" tabindex="0" role="button" data-mdb-toggle="popover"
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-secondary" href="profile.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-secondary" href="orders.html">
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-secondary" href="invoice.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-secondary" href="trackOrder.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-secondary" href="logOut.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
